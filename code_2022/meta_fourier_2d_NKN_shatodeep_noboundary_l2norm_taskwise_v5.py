...
base_dir = './v5_deep_models_trained_l2norm_taskwise_new/batch_size_%d_res_22_22_%d_%d_2D_Darcy_FNO_%d/shatodeep_samew_ntrain%d_NKN_s%d' %(batch_size,width,last_width,task_num,ntrain_pertask,s)
...
for nlayer in range(4):
    ...
    optimizer_test =  Adam([{'params': model.fc2[task_num].parameters()},{'params': model.fc1[task_num].parameters()}], lr=learning_rate, weight_decay=1e-2)
